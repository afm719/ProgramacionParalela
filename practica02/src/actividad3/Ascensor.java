...
public class Ascensor extends TimerTask
{
     ...
     */
    public void insertaEnPasillo(Persona p, int planta)
    {
     ...
     */
    public void borraDePasillo(Persona p, int planta)
    {
     ...
     * @param  planta entero con la planta (rango 0-4) en la que se inserta la persona
     */
    public void insertaEnEspera(Persona p, int planta)
    {
     ...
     * @param  planta entero con la planta (rango 0-4) de la que se borra la persona
     */
    public void borraDeEspera(Persona p, int planta)
    {
     ...
     * @param  p persona a insertar
     */
    public void insertaEnAscensor(Persona p)
    {
        listaAscensor.add(p);
    }
     ...
     * @param  p persona a borrar
     */
    public void borraDeAscensor(Persona p)
    {
